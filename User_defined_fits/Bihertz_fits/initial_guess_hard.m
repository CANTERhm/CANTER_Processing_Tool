function [E_h,d_h,varargout] = initial_guess_hard(x,y,perc,angle,poisson,varargin)
...
% 
%   [E_h,d_h] = initial_guess_hard(x,y,perc,angle,poisson)
...
%   
% 
%   [E_h,d_h,gof] = initial_guess_hard(x,y,perc,angle,poisson)
...
%
%   [E_h,d_h,gof] = initial_guess_hard(...,Name,Value)
...
% 
% Example:
%   [E_h,d_h,gof] = initial_guess_hard(x_values,y_values,5,17.5,0.5,'plot','on')
