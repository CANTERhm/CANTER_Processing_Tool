...
2. Put the downloaded zip file in a folder dedicated for the *CANTER Processing Toolbox* and unzip it.
...
4. (Optional) You can install the *CANTER Processing Toolbox* to your MATLAB Apps for an easier access.<br>
