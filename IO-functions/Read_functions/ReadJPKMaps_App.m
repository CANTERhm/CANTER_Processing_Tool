function [x_data,y_data, x_data_retract, y_data_retract, Forcecurve_count, varargout]=ReadJPKMaps_App(app,varargin)
% ReadJPKMaps  Reads .jkp-force-map files and returns the x and y values of
% the extend and retract curves
%
% Function call:
% [x_data,y_data, x_data_retract, y_data_retract, Forcecurve_count, varargout] = ReadJPKMaps_App(app,varargin)
% 
% Instruction: 
...
wbar.Message = "Reading Map Image Data ...";
...
% wbar.Value = 0;
wbar.Message = "Decoding all channels";
wbar.Indeterminate = "on";
